...
| 目的 | ダウンロードするもの |
| --- | --- |
| NTS-1 に入れてすぐ使いたい | [`shimmer_revfx.ntkdigunit`](https://github.com/ksd6700/shimmer_revfx_mki-NTS-1-digital-kit/raw/main/shimmer_revfx.ntkdigunit) をダウンロードしてください。これが NTS-1 Sound Librarian に読み込ませる完成ファイルです。 |
...
NTS-1 Sound Librarian に読み込ませるファイルは [`shimmer_revfx.ntkdigunit`](https://github.com/ksd6700/shimmer_revfx_mki-NTS-1-digital-kit/raw/main/shimmer_revfx.ntkdigunit) です。`shimmer_revfx.cpp`、`manifest.json`、`Makefile`、`ld/`、`tpl/` はビルド用のソース／設定ファイルです。
...
完成済みの [`shimmer_revfx.ntkdigunit`](https://github.com/ksd6700/shimmer_revfx_mki-NTS-1-digital-kit/raw/main/shimmer_revfx.ntkdigunit) を使う場合:
...
| --- | --- |
| I just want to load it into my NTS-1 | Download [`shimmer_revfx.ntkdigunit`](https://github.com/ksd6700/shimmer_revfx_mki-NTS-1-digital-kit/raw/main/shimmer_revfx.ntkdigunit). This is the ready-to-load user unit for NTS-1 Sound Librarian. |
...
The file you load into NTS-1 Sound Librarian is [`shimmer_revfx.ntkdigunit`](https://github.com/ksd6700/shimmer_revfx_mki-NTS-1-digital-kit/raw/main/shimmer_revfx.ntkdigunit). `shimmer_revfx.cpp`, `manifest.json`, `Makefile`, `ld/`, and `tpl/` are source and build files.
...
To use the ready-built [`shimmer_revfx.ntkdigunit`](https://github.com/ksd6700/shimmer_revfx_mki-NTS-1-digital-kit/raw/main/shimmer_revfx.ntkdigunit):
